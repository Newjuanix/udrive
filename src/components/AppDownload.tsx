...
const AppDownload = () => {
  const handleAppStoreClick = (e: React.MouseEvent) => {
    ...
    toast({
      ...
      description: "Estamos trabajando en nuestra aplicación para iOS. ¡Muy pronto estará disponible!",
      duration: 3000,
    });
  };
  ...
  const handleGooglePlayClick = (e: React.MouseEvent) => {
    ...
    toast({
      title: "Aplicación en desarrollo",
      description: "Estamos trabajando en nuestra aplicación para Android. ¡Muy pronto estará disponible!",
      duration: 3000,
    });
  };
